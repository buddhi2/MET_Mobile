        ...
        <div class="wrapper" style="margin-top: -16% !important;">
            <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <h5 class="m-t-0 text-white" style="text-align: center"><b>වර්ෂාපතනය</b></h5>
                                        </div>
                                    </div><!-- End row -->
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <h5 class="m-t-0 text-white" style="text-align: center"><b>උෂ්ණත්වය</b></h5>
                                        </div>
                                    </div><!-- End row -->
                                </div>
                                <div class="col-md-5" style="margin-top: 5%">
                                   <div class="row">
                                        <div class="col-6 text-center">
                                            <h6 class="text-white m-t-0">අවම</h6>
                                            <h4 class="text-white">
											<?php echo  $min_temp_array[$day]; ?>
											<i class="wi wi-degrees"></i>C</h4>
                                        </div>
                                        <div class="col-6 text-center">
                                            <h6 class="text-white m-t-0">උපරිම</h6>
                                            <h4 class="text-white">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <h5 class="m-t-0 text-white" style="text-align: center"><b>සුළඟ</b></h5>
                                        </div>
                                    </div><!-- End row -->
                                </div>
                                <div class="col-md-5" style="margin-top: 5%">
                                    <div class="row">
                                        <div class="col-6 text-center">
                                            <h6 class="text-white m-t-0">දිශාව</h6>
                                            <h4 class="text-white">
											<?php 
                                        ...
                                        <div class="col-6 text-center">
                                            <h6 class="text-white m-t-0">වේගය</h6>
                                            <h4 class="text-white">
											<?php echo  $wind_speed; ?>
											km/h
											</h4>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <h5 class="m-t-0 text-white" style="text-align: center"><b>ආර්ද්‍රතාවය</b></h5>
                                        </div>
                                    </div><!-- End row -->
                                </div>
                                  <div class="col-md-5" style="margin-top: 5%">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box bg-info" style="background-color:#00569E !important;">
                            <a href="sinhalaLanguage.php"><button type="button" class="btn btn-block btn--md btn-danger waves-effect waves-light"><i class="fa fa-backward"></i>&nbsp;&nbsp;&nbsp;&nbsp;ප්‍රධාන මෙනුවට</button></a>
                        </div>
                    </div>
                </div>
                <!-- End row -->

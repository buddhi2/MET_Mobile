...
for ($k=0;$k<7;$k++) {
	...
	echo "
								 ...
								 <div class='wthree-grids-row'>
                                    <ul>
                                        <li style='color: white !important;'>$ret[$k]<a href='index_1_Tamil.php?d=$k&lat=$lat&lon=$lon'><button class='float'><li class='fa fa-angle-right' style='color: white !important;'></li><div style='margin-top: -5px !important'>More</div></button></a></li>

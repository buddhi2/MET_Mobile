 ...
 <script>
  function getDayWetherSingleLocation(lat,lon) {
			...
			ajaxObject.onreadystatechange = function(){		
					...
					ajaxObject.open("GET","getDayWetherSingleLocation_Tamil.php?lat="+lat+"&lon="+lon,true);
			ajaxObject.send(); 
    }
                                ...
                                <div class="dmy">
                                    ...
                                    <div class="date">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            if (daym < 10)
                                                daym = "0" + daym
                                            var dayarray = new Array("ஞாயிற்றுக்கிழமை", "திங்கட்கிழமை", "செவ்வாய்", "புதன்கிழமை", "வியாழக்கிழமை", "வெள்ளி", "சனிக்கிழமை")
                            ...
                            <div class="wthree-grids">
                                 <div class="wthree-grids-row">
                                    <ul class="top" style="float: right">
                                        <li style="color: white !important;margin-right: 30px" class="wthree-temp degree">அதிகபட்சம்</li>
                                        <li style="color: white !important;" class="wthree-temp degree">      குறைந்தது</li>
                                    </ul> 
                                    <div class="clear"> </div>
                                </div>
								<div id="data_content">
...
<!--
                <div class="w3ls-bottom" >
                    <h2 style="color: #00569E;">இன்றைய வானிலை   </h2>
